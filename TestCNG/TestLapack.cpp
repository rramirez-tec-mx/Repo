...
TEST(TestLapack, calcMatrixProduct)
{
	...
	lapackClass.calcMatrixProduct(matriceA, matriceB, matriceC, 1, CBLAS_TRANSPOSE::CblasNoTrans, CBLAS_TRANSPOSE::CblasNoTrans);
}
...
TEST(TestLapack, calcMatrixInversion)
{
	...
	ASSERT_EQ(-0.056603773584905669,matriceAFlatten[4]);
	...
	ASSERT_EQ(-0.056603773584905641,matriceAFlatten[8]);
}
...
//    13    83
	...
	lapackClass.calcMatrixProduct(matriceA, matriceB, matriceC, 2, CBLAS_TRANSPOSE::CblasNoTrans, CBLAS_TRANSPOSE::CblasNoTrans);
